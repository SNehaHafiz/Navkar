...
{
    public class MovementPendancyEntities
    {
        ...
        public string IGMStatus {get;set;}
        ...
        public string GateinatICDStatus {get;set;}
        public string MarketingPerson { get; set; }
        public string KAM { get; set; }
        public string KAMTeamManagementTeamLastCheckedOn { get;set;}
