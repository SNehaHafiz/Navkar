...
$(document).ready(function () {
   ...
   //=======End====Initialize Control================
    ...
    ExportReceiptCtrl.PrintButton = btnPrint;
    ExportReceiptCtrl.ReceiptNo = txtReceiptNo;
    ExportReceiptCtrl.ReceiptDate = txtReceiptDate;
    ExportReceiptCtrl.CategoryMode = ddlCategoryMode;
    ExportReceiptCtrl.SearchCriteria = ddlSearchCriteria;
    ExportReceiptCtrl.AssessmentNo = txtAssessmentNo;
    ExportReceiptCtrl.IGMNo = txtIGMNo;
    ExportReceiptCtrl.BLNo = txtBLNo;
    ExportReceiptCtrl.ItemNo = txtItemNo;
    ExportReceiptCtrl.BOENo = txtBOENo;
    ExportReceiptCtrl.BondNo = txtBondNo;
    ExportReceiptCtrl.ShippingBillNo = txtShippingBillNo;
    ExportReceiptCtrl.CustomerName = ddlCustomerName;
    ExportReceiptCtrl.ShowInvoiceButton = btnShowInvoice;
    ExportReceiptCtrl.InvoiceList = tblInvoiceList;
    ExportReceiptCtrl.PaymentFrom = ddlPaymentFrom;
    ExportReceiptCtrl.ReceiptAmount = txtReceiptAmount;
    ExportReceiptCtrl.TDS = txtTDSAmount;
    ExportReceiptCtrl.PDDeposit = txtPDDeposit;
    ExportReceiptCtrl.Mode = ddlMode;
    ExportReceiptCtrl.AssmentAmount = txtAssmentAmount;
    ExportReceiptCtrl.ModeNo = txtModeNo;
    ExportReceiptCtrl.BankName = ddlBankName;
    ExportReceiptCtrl.ModeDate = txtModeDate;
    ExportReceiptCtrl.AddButton = btnAdd;
    ExportReceiptCtrl.PaymentDet = tblPaymentDet;
    ExportReceiptCtrl.Remarks = txtRemarks;
    ExportReceiptCtrl.SaveButton = btnSave;
    ExportReceiptCtrl.PrintButton = btnPrint;
    ExportReceiptCtrl.DivAssessmentNo = divAssessmentNo;
    ExportReceiptCtrl.DivIGMNo = divIGMNo;
    ExportReceiptCtrl.DivItemNo = divItemNo;
    ExportReceiptCtrl.DivBOENo = divBOENo;
    ExportReceiptCtrl.DivBLNo = divBLNo;
    ExportReceiptCtrl.DivShippingBillNo = divShippingBillNo;
    ExportReceiptCtrl.DivCustomerName = divCustomerName;
    ExportReceiptCtrl.DivShowButton = divShowButton;
    ExportReceiptCtrl.DivBondNo = divBondNo;
    ExportReceiptCtrl.ClearValueButton = btnclearValue;
    ExportReceiptCtrl.CustomerNameFrom = ddlCustomerName1;
    ExportReceiptCtrl.TableReceiptSummaryDet = tblReceiptSummaryDet; 
    ExportReceiptCtrl.ShowSummaryButton = btnShowSummary; 
    ExportReceiptCtrl.SummaryFromDate = txtSummaryFromDate; 
    ExportReceiptCtrl.SummaryToDate = txtSummaryToDate; 
    ExportReceiptCtrl.ReceiptType = ddlReceiptType;
    ExportReceiptCtrl.DropTDSPercentage = ddlTDSPerc;
    ExportReceiptCtrl.BalanceAmount = txtBalanceAmount;
    ExportReceiptCtrl.TablePendingInvoiceList = tblPendingInvoiceList;
    ExportReceiptCtrl.DivPendingInvoice = divPendingInvoice;
    ExportReceiptCtrl.HiddenPayFromId = hdnPayFromId;
    //=======End====Initialize Control to Object================


    //=============Call Function On DOM Ready Event===============
    ValidateSearchCret(ExportReceiptCtrl);
    AutomCom(ExportReceiptCtrl);
    GetPartyNameReceiptBind(ExportReceiptCtrl);
    $("#ddlTDSPerc").val(4);
    //===========End==Call Function On DOM Ready Event============

    //=============Call Validate Function on Select Cretria=======
    ExportReceiptCtrl.SearchCriteria.change(function () {
    ...
    ExportReceiptCtrl.CategoryMode.change(function () {
        GetPartyNameReceiptBind(ExportReceiptCtrl);
    });
    //===========End==Call Categry Change=========

    //====Call On Print Show Invoice Button ================
    ExportReceiptCtrl.ShowInvoiceButton.click(function () {
        //if (Validation(ExportReceiptCtrl) == false) {
        //    return;
        //};
        $("#tracker-loader").fadeIn("slow");
        DisplayInvoiceList(ExportReceiptCtrl);
    });
    //==End==Call On Print Show Invoice Button =============

    //===Initial Bind Details==============================
    InitializeTable(ExportReceiptCtrl);
    //===End Bind Details==============================

    //====Call On Save Receipt Button ================
    ExportReceiptCtrl.SaveButton.click(function () {
        
        Save(ExportReceiptCtrl);    
    });
    //==End==Call On Save Receipt Button =============
    
    //====Call On Clear Button ================
    ExportReceiptCtrl.ClearValueButton.click(function () {
        
        ClearControl(ExportReceiptCtrl);
    });
    //====Call On Clear Button ================

    //====Call On Add Button ================
    ExportReceiptCtrl.AddButton.click(function () {
        addPaymentList(ExportReceiptCtrl);
    });
    //====Call On Add Button ================

    //====Show Import Receipt Print Details================
    ExportReceiptCtrl.PrintButton.click(function () {
        //
        PrintReceipt(ExportReceiptCtrl);
    });
    //====End Import Receipt Print Details================
    //addReceivedAmt();

    //=============Call Receipt Summary Button=======
    ExportReceiptCtrl.ShowSummaryButton.click(function () {
        
        GetReceiptGenSummary(ExportReceiptCtrl);
    });
    //==========End===Call Receipt Summary Button=======

    //=============Call On Payment Mode Change Drop Down=======
    ExportReceiptCtrl.Mode.change(function (e) {
        
        var id = $(this);
        var text = this.options[e.target.selectedIndex].text;
        var ddlValue = this.options[e.target.selectedIndex].value;
        ValidatePaymentMode(ExportReceiptCtrl, ddlValue);
    });
    //=============End Call On Payment Mode Change Drop Down====

    //=============Call On TDS Amount Changes Text Box=======
    //ExportReceiptCtrl.TDS.change(function () {
    //    debugger;
    //    CalculateAutoTDSAmount(ExportReceiptCtrl);
    //});
   //===========End==Call On TDS Amount Changes Text Box======

    $("#aDivShow").click(function () {
        GetDailyConnection(ExportReceiptCtrl);
    });
    ...
    $("#aDivShowInvoice").click(function () {
        ...
        GetPendingInvoiceList(ExportReceiptCtrl);
    });
    //========End=====Call On Show Invoice Pending Div=====

    ExportReceiptCtrl.PaymentFrom.change(function () {
        AutoCustomer(ExportReceiptCtrl);
    });
});
...
function PrintReceipt(ControlCtrl) {
    ...
    $.ajax({
        url: '/ExportReceipt/ExportReceiptPrint',
        type: 'Post',
        data: data,
        async: false,
...
function DisplayInvoiceList(ControlCtrl) {
    ...
    $.ajax({
        url: '/ExportReceipt/GetInvoiceList',
        type: 'Post',
        data: data,
        async: false,
        contentType: 'application/json; charset=utf-8',
        success: function (data) {
            ...
            if (data.length == 0 || data == '[]') {
                ...
                alert('Please generate receipt from Receipt module.');
                return;
            }
            ...
            //            "data": "TDS",
            //            "render": function (data, type, row, meta) {
            //                input = '<input type=\"text\" name=\"TDS\" class=\" form-control TDS\" disabled=\"disabled\" "\ id=\"TDS\"  value="' + data + '">';
            //                return input;
            //            }
            //        },
...
function GetReceiptGenSummary(ControlCtrl) {
    ...
    debugger;
    $.ajax({
        url: '/ExportReceipt/getReceiptSummaryDet',
        type: 'Post',
...
function GetPendingInvoiceList(ControlCtrl) {
    ...
    $.ajax({
        url: '/ExportReceipt/getPenginInvoiceList',
        type: 'Post',
        data: '',
        async: false,
        contentType: 'application/json; charset=utf-8',
...
function GetDailyConnection(ControlCtrl) {
    ...
    $.ajax({
        url: '/ExportReceipt/DailyCollection',
        type: 'Post',
        data: '',
        async: false,
        contentType: 'application/json; charset=utf-8',
...
function CancelRec(RecNo) {
    ...
    if (r == true) {
        ...
        $.ajax({
            type: "POST",
            url: "/ExportReceipt/CancelReceipt",
            data: data,
            contentType: "application/json; charset=utf-8",
            success: function (response) {
                debugger;
...
function AutomCom(ControlCtrl) {
    ...
    $("#ddlCustomerName1").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: "/ExportReceipt/getAutoCustomerList",
...
function GetPartyNameReceiptBind(ControlCtrl) {
    ...
    $.ajax({
        url: '/ExportReceipt/getPartyNameReceipt',
        type: 'Post',
        data: data,
        async: false,
        contentType: 'application/json; charset=utf-8',
...
function ClearControl(ControlCtrl) {
    ...
    ControlCtrl.ReceiptDate.val('');
    ControlCtrl.CategoryMode.val('ExportInvoice');
