...
$(document).ready(function () {
    ...
    ExportSplitingCtrl.IGMNo = txtIGMNo;
    ExportSplitingCtrl.ItemNo = txtItemNo;
    ExportSplitingCtrl.ShowButton = btnShow;
    ExportSplitingCtrl.SaveButtom = btnSave;
    ExportSplitingCtrl.tblContainer = tblContainerDet;
    ExportSplitingCtrl.tblItem = tblItemDet;
    ExportSplitingCtrl.SplitType = ddlSplitType;
    ExportSplitingCtrl.SplitBlNo = txtSplitBlNo;
    ExportSplitingCtrl.MSItemNo = txtMSItemNo;
    ExportSplitingCtrl.btnclearValue = btnclearValue;
    ExportSplitingCtrl.ShowSummary = btnShowSummary;
    ExportSplitingCtrl.tblSplitingSummary = tblSplitingSummaryDet;
    ExportSplitingCtrl.FromDate = txtFromDate;
    ExportSplitingCtrl.ToDate = txtToDate;
    ExportSplitingCtrl.SelectAllContainer = chkSelectAllC;
    ExportSplitingCtrl.SelectAllItem = chkSelectAllI;
    //=======End====Initialize Control Object================

    //==Begin==Select All Container From Table==============
    ExportSplitingCtrl.SelectAllContainer.click(function () {
        debugger;
        var chkAll = this;
        var chkRows = ExportSplitingCtrl.tblContainer.find("#chkSelect");
    ...
    ExportSplitingCtrl.SelectAllItem.click(function () {
        debugger;
        var chkAll = this;
        var chkRows = ExportSplitingCtrl.tblItem.find("#chkSelect");
        chkRows.each(function () {
            debugger;
            $(this)[0].checked = chkAll.checked;
        });
    ...
    ExportSplitingCtrl.ShowButton.click(function () {
        //debugger;
        //===Begin Validate Control==================
        if (ValidateControl(ExportSplitingCtrl) == false) {
            return;
        };
    //===End Validate Control==================
        ShowContainerDet(ExportSplitingCtrl);
    });
    //==End==Call On Show Button for Getting Data From Controller

    //==Begin==Save data==============================================
    ExportSplitingCtrl.SaveButtom.click(function () {
        //debugger;
        Save(ExportSplitingCtrl);
    });
    //==End==Save data================================================

    //===Initial Bind Details==============================
    InitializeTable(ExportSplitingCtrl);
    //===End Bind Details==============================

    //===Clear Control==============================
    ExportSplitingCtrl.btnclearValue.click(function () {
        debugger;
        ClearControl(ExportSplitingCtrl);
    });
    //===End Clear Control==============================

    //====Show Spliting Summary Log Details================
    ExportSplitingCtrl.ShowSummary.click(function () {
        //debugger;
        ShowContainerSummary(ExportSplitingCtrl);
    });
...
function ShowContainerDet(ControlCtrl) {
    ...
    $.ajax({
        url: '/ExportSpliting/GetImportSplitingData',
        type: 'Post',
        data: data,
        async: false,
...
function ShowContainerSummary(ControlCtrl) {
    ...
    $.ajax({
        url: '/ExportSpliting/ExportToExcelSplitingSummary',
        type: 'Post',
        data: data,
        async: false,
        contentType: 'application/json; charset=utf-8',
